...
call assert(abs(Etot - (-2.91002381_dp)) < 1e-8_dp)
call assert(all(abs(lam(:2, 0) - [-0.96621685_dp, 0.78762504_dp]) < 1e-8_dp))
call assert(all(abs(lam(:2, 1) - [ 1.07132548_dp, 4.98297964_dp]) < 1e-8_dp))
call assert(all(abs(lam(:2, 2) - [ 3.69445430_dp,16.68043160_dp]) < 1e-8_dp))

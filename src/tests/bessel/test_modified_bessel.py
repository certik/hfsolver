...
def Ik1(x):
    ...
    if x < 0.55:
        ...
        r = (-1.0118340437504393201742626606e-13 + \
                x*(1.816670640113517482116741309e-12 + \
                x*(0.333333333318047257036705475493 + \
                x*(0.0283477684328350973136495456416 + \
                x*(0.0236972901524850660936691284628 + \
                x*(0.0018095002919993302530473889535 + \
                x*(0.000376379638016770111327098946609 + \
                (0.0000200246480593843172713997406232 + \
                1.01338637272678665804111511983e-6*x)*x)))))))/ \
            (1. + x*(1.08504330505794283765963608202 + \
                x*(0.556135176398351735247605123725 + \
                x*(0.177204358493610809522295217793 + \
                x*(0.0387591827785532218461461492913 + \
                x*(0.00603331772767809320892209353842 + \
                x*(0.000663930390602843320578606798458 + \
                (0.0000484437498700383824299885362686 + \
                1.88315077527785406856560709781e-6*x)*x)))))))
    elif x < 20:
...
def Ik2(x):
    ...
    if x < 0.4:
        ...
        r = (-0.0500329770733375148059871692299 + \
                x*(0.225443974816227263854027844348 + \
                x*(-0.490706738714676572173733908052 + \
                x*(0.754739228306267786750520915722 + \
                x*(-0.0229222956512753039643375612586 + \
                x*(0.0417199171935382735527783646423 + \
                x*(0.00129242688582393560040014185308 + \
                (0.000436655909016956929989211236885 + \
                0.0000544588062620298286123134699247*x)*x)))))))/ \
            (1. + x*(11.1481461018360358000411784178 + \
                x*(2.95111664564331863128521306942 + \
                x*(2.07069035717497213861002964422 + \
                x*(0.212130624675779325122087859297 + \
                x*(0.0985267048591193186479900210954 + \
                x*(0.00581026870781213052737501655128 + \
                (0.00120128946303470807826705767304 + \
                0.000108903528444754760503502120599*x)*x)))))))
    elif x < 20:
...
def Ik4(x):
    ...
    if x < 0.2:
        ...
        r = (1.49435717183021678294278540018 + \
            x*(-1.9954827594990599398954087063 + \
            x*(1.19185825369343226912112655137 + \
            x*(-0.40866680980235804096143699423 + \
            x*(0.0852839860059780325406440673318 + \
            (-0.00980617919194154929317057489645 + \
            0.000550291361244287676343295379476*x)*x)))))/\
        (1. + x*(0.420439518058743727857466136746 + \
            x*(0.144024726914933127664739439568 + \
            x*(0.035261250406130055921113600336 + \
            x*(0.0349770458351085078647522073879 + \
            (-0.00860653991097136433951965579037 + \
            0.00110058277850687516223459976889*x)*x)))))
    else:

...
def Ik3(x):
    if x < 0.4:
        ...
        r = (-3.27538797370945665212677910293e25 + \
            x*(1.44004887055117338502004912517e26 + \
            x*(-3.02398472113181225334519457728e26 + \
            x*(4.03518215716621263580663840484e26 + \
            x*(-3.83742929971438427464737151265e26 + \
            x*(4.40842398799437889268089220068e25 + \
            x*(-1.94537121293065186483810178767e25 + \
        (1.09004374332873953104490055555e24 - \
            2.26002623200055133559898567956e23*x)*x)))))))/ \
            (1. + x*(-2.43653436725091740844829927281e28 + \
            x*(-1.00860581265374744012071042378e28 + \
            x*(-3.73225378050902712271655242585e27 + \
            x*(-9.90063352714661813179076860131e26 + \
            x*(-1.21686458483727639037936095573e26 + \
            x*(-3.53642789843215083723403648805e25 + \
            (-5.30632386307380439477631046741e23 - \
            4.52021709487124696382849807848e23*x)*x)))))))
    elif x < 20:

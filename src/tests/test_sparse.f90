...
call assert(abs(csr_getvalue(Bp, Bj, Bx, 1, 1) - 5) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 1, 2) - 0) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 1, 3) - 0) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 1, 4) - 0) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 2, 1) - 0) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 2, 2) - 0) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 2, 3) - 7) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 2, 4) - 1) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 3, 1) - 0) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 3, 2) - 3) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 3, 3) - 0) < tiny(1._dp))
call assert(abs(csr_getvalue(Bp, Bj, Bx, 3, 4) - 0) < tiny(1._dp))
